...
const setUserProfileInLocalStorage = (key, value) => {
    try {
        localStorage.setItem(key, JSON.stringify(value));
    }
    catch (error) {
...
const accounts = getUserProfileFromLocalStorage("profile") || [];
export { setTokenDetailsInLocalStorage, getTokenDetailsInLocalStorage, setUserProfileInLocalStorage, getUserProfileFromLocalStorage, deleteStorageItem, requestedErc721s, requestedErc1155s, requestedErc20s, requestedEth, offeredErc721s, offeredErc1155s, offeredErc20s, offeredEth, accounts, };
