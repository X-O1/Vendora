...
const createCommonTokenMenuElements = (option) => {
    ...
    tokenName.classList.add("option-name");
    tokenSymbol.classList.add("option-symbol");
    tokenOrderDetailsDiv.classList.add("option-order-details");
    tokenId.classList.add("option-token-id");
    tokenAmount.classList.add("option-amount");
    offerToken.classList.add("offer-asset-button");
    requestToken.classList.add("request-asset-button");
