...
const addWantedErc721Button = document.querySelector(".add-wanted-erc721");
export { assetPopUpContainer, erc721MenuToggle, erc1155MenuToggle, erc20MenuToggle, erc721MenuPopUp, erc1155MenuPopUp, erc20MenuPopUp, toggleFullscreen, closeFullscreen, closeMenu, tokenOption, optionImage, optionName, optionSymbol, optionTokenId, optionAmount, termErc721s, termErc1155s, termErc20s, termAssets, selectAssets, selectAssetsH2, tokenStandardMenuOptionDiv, termAssetsH2, requestTab, offerTab, finalizeTermsTab, addWantedErc721Button, };
