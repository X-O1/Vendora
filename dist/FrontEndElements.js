...
const connectWalletButton = document.querySelectorAll(".connect");
...
const tradeNameInput = document.querySelector(".trade-name-input");
const requestedAssetsPreview = document.querySelector(".requested-assets-preview");
const requestedAssetsH2Preview = document.querySelector(".requested-assets-title-preview");
const requestedErc721sDivPreview = document.querySelectorAll(".requested-erc721s-preview");
const requestedErc1155sDivPreview = document.querySelectorAll(".requested-erc1155s-preview");
const requestedErc20sDivPreview = document.querySelectorAll(".requested-erc20s-preview");
const requestedEthDivPreview = document.querySelectorAll(".requested-eth-preview");
const offeredAssetsPreview = document.querySelectorAll(".offered-assets-preview");
const offeredAssetsH2Preview = document.querySelector(".requested-assets-title-preview");
const offeredErc721sDivPreview = document.querySelectorAll(".offered-erc721s-preview");
const offeredErc1155sDivPreview = document.querySelectorAll(".offered-erc1155s-preview");
const offeredErc20sDivPreview = document.querySelectorAll(".offered-erc20s-preview");
const offeredEthDivPreview = document.querySelectorAll(".offered-eth-preview");
const offeredAssetsTitlePreview = document.querySelectorAll(".offered-assets-title-preview");
const requestedAssetsTitlePreview = document.querySelectorAll(".requested-assets-title-preview");
export { assetPopUpContainer, erc721MenuToggle, erc1155MenuToggle, erc20MenuToggle, ethMenuToggle, erc721MenuPopUp, erc1155MenuPopUp, erc20MenuPopUp, ethMenuPopUp, toggleFullscreen, closeFullscreen, closeMenu, tokenOptionDiv, optionImage, optionName, optionSymbol, optionTokenId, optionAmount, termErc721s, termErc1155s, termErc20s, termEth, termAssets, selectAssets, selectAssetsH2, tokenStandardMenuOptionDiv, termAssetsH2, requestTab, offerTab, finalizeTermsTab, finalizeTermsDiv, requestedAssets, offeredAssets, requestedErc721sDiv, requestedErc1155sDiv, requestedErc20sDiv, requestedEthDiv, offeredErc721sDiv, offeredErc1155sDiv, offeredErc20sDiv, offeredEthDiv, offeredAssetsH2, requestedAssetsH2, requestedAssetsTitle, offeredAssetsTitle, setTermsButton, connectWalletButton, tradesDiv, finishTradeDiv, finishTradeContainer, activeTradesDiv, backToTrade, buildTradeTab, findTradeTab, tradesTab, tradesBox, buildBox, findBox, searchBar, searchButton, foundTradesDiv, findTradeContainer, activeTradesDiv2, tradesDiv2, finishTradeContainer2, finishTradeDiv2, backToTrade2, searchContainer, requestedAssetsPreview, requestedAssetsH2Preview, requestedErc721sDivPreview, requestedErc1155sDivPreview, requestedErc20sDivPreview, requestedEthDivPreview, offeredAssetsPreview, offeredAssetsH2Preview, offeredErc721sDivPreview, offeredErc1155sDivPreview, offeredErc20sDivPreview, offeredEthDivPreview, offeredAssetsTitlePreview, requestedAssetsTitlePreview, tradeNameInput, };
